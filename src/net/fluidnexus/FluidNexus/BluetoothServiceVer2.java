...
public class BluetoothServiceVer2 extends Service {
    // Logging
    ...
    private class ConnectThread extends Thread {
        ...
        private void sendDataForHash() {
            ...
            String message = localCursor.getString(localCursor.getColumnIndexOrThrow(MessagesDbAdapter.KEY_CONTENT));
            Integer timestamp = localCursor.getInt(localCursor.getColumnIndexOrThrow(MessagesDbAdapter.KEY_TIME));
